...
class CollaboratorsControllerTest < ActionController::TestCase
  ...
  test "should create collaborator" do
    assert_difference('Collaborator.count') do
      post :create, collaborator: { admission_date: @collaborator.admission_date, name: @collaborator.name, salary: @collaborator.salary }
    end
  ...
  test "should update collaborator" do
    patch :update, id: @collaborator, collaborator: { admission_date: @collaborator.admission_date, name: @collaborator.name, salary: @collaborator.salary }
    assert_redirected_to collaborator_path(assigns(:collaborator))
  end
